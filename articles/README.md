...
- [10 Essential Kubernetes Tools You Didn’t Know You Needed](https://itnext.io/10-essential-kubernetes-tools-you-didnt-know-you-needed-06954251d845)
- [Build & Push the Docker image to Docker Hub using GitHub Actions](https://overcast.blog/build-push-the-docker-image-to-docker-hub-using-github-actions-74f20d47c483)
- [3 Kafka Messaging Strategies](https://newsletter.systemdesigncodex.com/p/3-kafka-messaging-strategies)
...
- [Image upload/CRUD operations in .net core APIs](https://ravindradevrani.medium.com/image-upload-crud-operations-in-net-core-apis-7407f111d2f4)
- [Mastering NGINX Logs in Docker: From Novice to Ninja](https://karandeepsingh.ca/post/nginx-logs-and-docker-your-ultimate-guide/)
- [Redis Sorted Sets Explained](https://medium.com/analytics-vidhya/redis-sorted-sets-explained-2d8b6302525)
...
- [opire - code bounties](https://app.opire.dev/home)
